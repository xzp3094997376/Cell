...
namespace GCSeries
{
    public class StylusObjectManipulationSample : MonoBehaviour
    {
        ...
        private void UpdateStylusBeam(Vector3 stylusPosition, Vector3 stylusDirection)
        {
            ...
            {
                //float stylusBKCeamWidth  = DEFAULT_STYLUS_BEAM_WIDTH * FCore.ViewerScale;
        ...
        public static readonly float DEFAULT_STYLUS_BEAM_WIDTH  = 0.0002f;
        public static readonly float DEFAULT_STYLUS_BEAM_LENGTH = 2f;
